...
export default function Home({ onNavigate }: HomeProps) {
  ...
  const heroImage = "https://i.ibb.co/tP8X2QDc/42f6ffd3-e9e1-4992-b561-ee9a99b6c187.jpg";
...
<section className="bg-[#0A3764] text-white pt-32 pb-24 px-6 md:px-16">
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    >
      ...
      <div className="flex flex-wrap gap-4">
        <button
          ...
          className="bg-[#F9D342] text-[#0A3764] hover:bg-[#ffe067] transition-colors px-8 py-3 rounded-full font-semibold shadow-md"
        >
          Voir le programme
        </button>
        <button
          onClick={() => onNavigate("gallery")}
          className="border border-white text-white hover:bg-white hover:text-[#0A3764] transition-colors px-8 py-3 rounded-full font-semibold shadow-md"
        >
    ...
    >
      ...
      {/* === SECTION À PROPOS === */}
      <section className="py-24 px-6 md:px-16 bg-gradient-to-b from-white to-[#E6F0FF]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {activities.map((activity, index) => (
              <motion.div
                ...
                className="bg-[#F9FAFB] rounded-2xl shadow-md hover:shadow-xl p-8 text-left"
              >
                <activity.icon className="w-10 h-10 text-[#0A3764] mb-4" />
      ...
      {testimonials.length > 0 && (
        <section className="py-24 px-6 md:px-16 bg-gradient-to-b from-[#E6F0FF] to-white">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-[#0A3764] mb-6">
